...
#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN
  ...
  #define LEFT_PROBE_BED_POSITION 0 + MIN_PROBE_X
  #define RIGHT_PROBE_BED_POSITION 130 + MIN_PROBE_X
  #define FRONT_PROBE_BED_POSITION 0 + MIN_PROBE_Y
  #define BACK_PROBE_BED_POSITION 80 + MIN_PROBE_Y
  #define MIN_PROBE_EDGE 5
  #define Z_SAFE_HOMING_X_POINT MIN_PROBE_X
